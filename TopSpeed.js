// ==UserScript==
// @name         Hidove名华在线刷课极速版
// @namespace    https://www.hidove.cn/
// @version      1.0
// @description  10秒解决一部视频，超级快
// @author       Hidove 余生
...
(window.onload=function() {
	...
	if (window.console && window.console.log) {
		console.clear();
		console.log("%c 当前版本：Hidove名华在线刷课极速版 %c https://blog.hidove.cn ","color: #fadfa3; background: #030307; padding:5px 0;","background: #fadfa3; padding:5px 0;");
